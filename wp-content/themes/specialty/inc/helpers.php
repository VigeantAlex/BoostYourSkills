...
function specialty_admin_notice_sample_content() {
	...
	?>
	<div class="notice notice-info is-dismissible specialty-sample-content-notice">
		<p>
			<?php echo wp_kses( sprintf( __( 'It looks like the theme was just installed. <a href="%s" target="_blank">Download the sample content</a> to get things moving.', 'specialty' ),
